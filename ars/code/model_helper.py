...
from ars.code.utils import iterator_utils
    ...
    if share_emb:
      ...
      if vocab_file and embed_file:
        if src_embed_size != tgt_embed_size:
            raise ValueError("Share embedding but different src/tgt emb sizes"
                             " %d vs. %d" % (src_embed_size, tgt_embed_size))
        embedding = _create_pretrained_emb_from_txt(vocab_file, embed_file)
      else:
        embedding = tf.get_variable(
            "embedding_share", [vocab_size, src_embed_size], dtype)
      ...
      with tf.variable_scope("encoder", partitioner=partitioner):
        if vocab_file and src_embed_file:
          ...
          embedding_encoder = tf.get_variable(
              "embedding_encoder", [vocab_size, src_embed_size], dtype)
      ...
      with tf.variable_scope("decoder", partitioner=partitioner):
        if vocab_file and tgt_embed_file:
          ...
          embedding_decoder = tf.get_variable(
              "embedding_decoder", [vocab_size, tgt_embed_size], dtype)
