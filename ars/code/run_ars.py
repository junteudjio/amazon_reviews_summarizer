...
from ars.code import inference
from ars.code import train
from ars.code.utils import evaluation_utils
from ars.code.utils import misc_utils as utils
from ars.code.utils import vocab_utils
...
def add_arguments(parser):
  ...
  # network
  parser.add_argument("--num_units", type=int, default=250, help="Network size.")
  ...
  # data
  parser.add_argument("--src", type=str, default='review',
                      help="Source suffix")
  parser.add_argument("--tgt", type=str, default='summary',
                      help="Target suffix")
  parser.add_argument("--train_prefix", type=str, default=os.path.join("data", "ars", 'train'),
                      help="Train prefix.")
  parser.add_argument("--dev_prefix", type=str, default=os.path.join("data", "ars", 'val'),
                      help="Dev prefix.")
  parser.add_argument("--test_prefix", type=str, default=os.path.join("data", "ars", 'test'),
                      help="Test prefix.")
  parser.add_argument("--out_dir", type=str, default='model_ckpts',
                      help="Store log/model files.")

  # Vocab
  parser.add_argument("--vocab_dir", type=str, default=os.path.join("data", "ars"), help="""\
      Vocab prefix.\
      """)
  parser.add_argument("--vocab_filename", type=str, default='vocab.dat', help="""\
        Vocab file name.\
        """)

  parser.add_argument("--embed_dir", type=str, default=os.path.join("download", "dwr"), help="""\
      Pretrained embedding directory.
      """)
  parser.add_argument("--src_embed_filename", type=str, default='glove.6B.100d.txt', help="""\
        Pretrained embedding file.
        """)
  parser.add_argument("--tgt_embed_filename", type=str, default='glove.6B.100d.txt', help="""\
        Pretrained embedding file.
        """)
  parser.add_argument("--sos", type=str, default=u"<s>",
                      help="Start-of-sentence symbol.")
  parser.add_argument("--eos", type=str, default=u"</s>",
                      help="End-of-sentence symbol.")
  parser.add_argument("--share_emb", type="bool", nargs="?", const=True,
                      default=True,
                      help="""\
  ...
  parser.add_argument("--src_max_len_infer", type=int, default=100,
                      help="Max length of src sequences during inference.")
  parser.add_argument("--tgt_max_len_infer", type=int, default=10,
                      help="""\
...
def create_hparams(flags):
  ...
  return tf.contrib.training.HParams(
      ...
      src_embed_file=os.path.join(flags.embed_dir, flags.src_embed_filename),
      tgt_embed_file=os.path.join(flags.embed_dir, flags.tgt_embed_filename),
